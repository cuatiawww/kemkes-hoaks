...
export default function HomeHero({
  ...
  return (
    <section className="mx-auto max-w-[1160px] px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 relative z-30 min-h-[360px]">
        {/* Background Image & Gradient overlay with rounded corners and overflow hidden */}
        <div
          className="absolute inset-0 bg-cover bg-center rounded-2xl overflow-hidden pointer-events-none"
